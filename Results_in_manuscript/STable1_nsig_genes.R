...
res.out[1,3] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))

data.tmp = data[data[,7] < cutoff,]
res.out[2,3] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))
...
res.out[1,4] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))

data.tmp = data[data[,7] < cutoff,]

res.out[2,4] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))
...
res.out[1,1] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,16]< 5*10^{-8}), "/", sum(data.tmp[,18]< 5*10^{-8}))

data.tmp = data[data[,11] < cutoff,]

res.out[2,1] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,16]< 5*10^{-8}), "/", sum(data.tmp[,18]< 5*10^{-8}))
...
res.out[1,2] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,16]< 5*10^{-8}), "/", sum(data.tmp[,18]< 5*10^{-8}))

data.tmp = data[data[,11] < cutoff,]

res.out[2,2] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,16]< 5*10^{-8}), "/", sum(data.tmp[,18]< 5*10^{-8}))
...
data.tmp = data[data[,6] < cutoff,]
data.sum.mcf = data.tmp
res.out[1,5] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))

data.tmp = data[data[,7] < cutoff,]

res.out[2,5] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))
...
res.out[1,6] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[2,6] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[1,7] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[2,7] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[1,8] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[2,8] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[1,9] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[2,9] = paste0(dim(fina.aSPU)[1],"/",sum(fina.aSPU[,17]< 5*10^{-8}), "/",sum(fina.aSPU[,18]< 5*10^{-8}))
...
res.out[1,10] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))

data.tmp = data[data[,7] < cutoff,]
res.out[2,10] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))
...
res.out[1,11] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))

data.tmp = data[data[,7] < cutoff,]
res.out[2,11] = paste0(dim(data.tmp)[1],"/",sum(data.tmp[,10]< 5*10^{-8}), "/", sum(data.tmp[,12]< 5*10^{-8}))
