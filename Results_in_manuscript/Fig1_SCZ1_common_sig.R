...
fina.SPU1 = as.character(TWAS.SPU1[,2])
fina.SPU2 = as.character(TWAS.SPU2[,2])
...
fina.SPU1 = fina.SPU1[fina.SPU1%in% gene.used]
fina.SPU2 = fina.SPU2[fina.SPU2%in% gene.used]
...
category = c("E+G", "E+G+Mtheyl", "TWAS","STD"),
lty = "blank",
cex = 2,
margin = 0.1,
